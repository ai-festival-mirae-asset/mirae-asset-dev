...
| 파일 | 역할 |
|---|---|
| `ontology/*.ttl` | 어휘(클래스 15 · 관계 8 · 속성 37, 접두어 `fp: <http://mafest.ai/product#>`) — 공식 지정 파일명 5개 + SHACL 규칙 1개 |
...
## 4. 실측 결과 (2026-08-19 전체 재빌드 — 어휘 `fp:` 전환 후)

| 테이블 | 입력 행 | 상품 노드 | 참조 노드 | 트리플 | 제약 위반 |
|---|---|---|---|---|---|
| 국내채권 | 42,394 | 42,394 | 발행기관 8,018 | 740,914 | 0 |
| 국내ETF | 1,733 | 1,733 (ETF 1,201 · ETN 532) | 115 | 28,552 | 0 |
| 해외ETF | 5,646 | 5,646 (ETF 5,587 · ETN 59) | 2,103 | 86,086 | 0 |
| 공모펀드 | 95,618 | **11,138**(마스터) | 457 | 181,686 (+11,138 = 판매중 여부 신규) | 0 |
| 구성종목 | 75,081 | ETF 923 · 종목 6,819 | — | 90,986 (관계 67,205) | 0 |
| 합계 | — | 60,911 상품 | — | **1,128,224** | 0 |
